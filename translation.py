...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thank you <a href='https://t.me/ankittdeswal>**AnkitDeswal**</a> for helping us in this journey ❤️"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds.\n\n@ankittdeswal"
    SAVED_CUSTOM_THUMB_NAIL = "Custom video / file thumbnail saved. This image will be used in the video / file."
    DEL_ETED_CUSTOM_THUMB_NAIL = "✅ Custom thumbnail cleared succesfully."
    CUSTOM_CAPTION_UL_FILE = "{}"
    NO_VOID_FORMAT_FOUND = "ERROR...\n<b>ankittdeswal</b> said: {}"
...
Contact ADMIN if any error occurs @ankittdeswal"""
...
The 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 has not allowed me to upload files from the urls which is send by an unAuthorised member.
